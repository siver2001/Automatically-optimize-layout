...
const PackingResult = () => {
  ...
  // Cập nhật scale khi resize màn hình
  useEffect(() => {
    const updateScale = () => {
  ...
  return (
    <div className="mb-4 card p-3 md:p-4"> 
