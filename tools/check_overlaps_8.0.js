...
async function run() {
  ...
  console.log(`Checking physical overlaps for Size 8.0...`);
  ...
  for (const sizeInfo of sizes) {
    ...
    if (placements.length === 0) {
      console.log(`Size 8.0: No placements found!`);
      continue;
    }
    ...
    console.log(`Size 8.0: Total placements = ${placements.length}, Physical overlaps found = ${overlapsCount}`);
  }
}
