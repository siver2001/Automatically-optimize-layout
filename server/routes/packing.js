...
router.get('/rectangles', (req, res) => {
  const defaultRectangles = [
    ...
    { id: 2, width: 360.0, length: 122.5, name: '14#-15#' },
    { id: 3, width: 345.0, length: 240.0, name: '12.5#- 13.5#' },
    { id: 4, width: 345.0, length: 120.0, name: '12.5#- 13.5#' },
    { id: 5, width: 335.0, length: 230.0, name: '11#-12#' },
    { id: 6, width: 335.0, length: 115.0, name: '11#-12#' },
    { id: 7, width: 320.0, length: 225.0, name: '9.5#-10.5#' },
    { id: 8, width: 320.0, length: 112.5, name: '9.5#-10.5#' },
    { id: 9, width: 305.0, length: 220.0, name:  '8#-9#' },
    { id: 10, width: 305.0, length: 110.0, name: '8#-9#' },
    { id: 11, width: 295.0, length: 215.0, name: '6.5#-7.5#' },
    { id: 12, width: 295.0, length: 107.5, name: '6.5#-7.5#' },
    { id: 13, width: 280.0, length: 205.0, name: '5#- 6#' },
    { id: 14, width: 280.0, length: 102.5, name: '5#- 6#' },
    { id: 15, width: 270.0, length: 200.0, name: '3.5#- 4.5#' },
    { id: 16, width: 270.0, length: 90.0, name:  '3.5#- 4.5#' }
  ].map(rect => ({
    ...rect,
